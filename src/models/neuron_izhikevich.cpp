...
neuron_izhikevich::neuron_izhikevich(QWidget *parent, int NumberNeuronsGroup, QString label, float posX, float posY, QString ip, int idGlobalNeuron, int typeNeuron, int localRemote, Parameters *p, double w_default, QString fx,
...
void neuron_izhikevich::sendDataToGeneralMonitor(bool spiking){
...
void neuron_izhikevich::paintLocalMonitor(){
    if (!monitor)
