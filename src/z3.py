...
input_G1_1G4_4=sim.Projection(G1_1,G4_4, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=1.7, delay=0))
input_G1_1Dani_5=sim.Projection(G1_1,Dani_5, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=1.3, delay=0))
input_G1_1G5_6=sim.Projection(G1_1,G5_6, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=1, delay=0))
input_G2_2G1_1=sim.Projection(G2_2,G1_1, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=0.1, delay=0))
input_G4_4G4_4=sim.Projection(G4_4,G4_4, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=1, delay=0))
input_G6_7G1_1=sim.Projection(G6_7,G1_1, sim.OneToOneConnector(), synapse_type.StaticSynapse(weight=1, delay=0))
