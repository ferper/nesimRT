...
GEN1_3= sim.Population(1,sim.SpikeSourceArray(spike_times=[1,2,4,6,7],label="GEN1_3"))
...
input_Dani_5G1_1=sim.Projection(Dani_5,G1_1, sim.OneToOneConnector(), synapse_type=sim.StaticSynapse(weight=1.3, delay=0))
